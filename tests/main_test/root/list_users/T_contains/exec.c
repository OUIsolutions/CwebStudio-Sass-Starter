...
int main(){
    ...
    ApiBridge_create_user(bridge,"Rodrigo Moutinh","mateusmoutinho01@gmail.com","aaaaaaaaaaaaaaaaaaaaaa",false,false);
    ApiBridge_list_users(bridge,"Mateus",true,true);
